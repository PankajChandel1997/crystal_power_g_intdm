...
namespace Gurux.DLMS.Secure
{
    public class GXDLMSSecureClient : GXDLMSClient
    {
        ...
        public GXDLMSSecureClient(bool useLogicalNameReferencing,
                                  int clientAddress, int serverAddress, Authentication authentication,
                                  string password, InterfaceType interfaceType, Security security, byte[] systemTitle, byte[] blockCipherKey, byte[] authenticationKey)
            : base(useLogicalNameReferencing,
                clientAddress, serverAddress, authentication,
                password, interfaceType)
        {
            //Ciphering = new GXCiphering(ASCIIEncoding.ASCII.GetBytes("GRX12345"));
            Ciphering = new GXCiphering(1, systemTitle, blockCipherKey, authenticationKey);
            Settings.Cipher = Ciphering;
